...
%     for c = 1:Ne
%         TV on fluorescence map directly (real image)
%         u = O(:,:,c);
% 
...
% end
% 
% add TV to objective and gradient
% f    = f + f_tv;
% df_I = df_I + g_tvO;
% 
% pack output gradient as vector (match your original)
% df_I = df_I(:);
% 
% end
