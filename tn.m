function [xstar, infos, ierror] = tn (x, sfun, v_o_true, eig_val_need, separate_loss)
%---------------------------------------------------------
...
%---------------------------------------------------------
[xstar, infos, ierror] = lmqn (x, sfun, maxit, maxfun, stepmx, accrcy, v_o_true, eig_val_need, separate_loss);
